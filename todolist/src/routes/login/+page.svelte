...
<div class="login-cn flex vert center">
	...
	<button class="flex"><img src="https://img.icons8.com/color/48/null/google-logo.png"/>Continue with Google</button>
	<button class="flex"><img src="https://img.icons8.com/ios-glyphs/30/null/mac-os.png"/>Continue with Google</button>
	...
	<button class="flex email-btn">Continue with email</button>
</div>
